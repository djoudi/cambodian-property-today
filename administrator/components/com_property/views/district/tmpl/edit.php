...
<form action="<?php echo JRoute::_("index.php?option=com_property&layout=edit&id={$this->item->id}"); ?>" method="post" name="adminForm" id="province-form" class="form-validate">
    <div>
        <fieldset class="adminform">
            <legend><?php echo empty($this->item->id) ? JText::_('Add District') : JText::sprintf('Edit District', $this->item->id); ?></legend>
            ...
            <table class="adminform" >
                ...
                <tr>
                    <td valign="top" > <?php echo $this->form->getLabel('id_province'); ?></td>
                    <td> <?php echo $this->form->getInput('id_province'); ?></td>
                </tr>
